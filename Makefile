...
CXXFLAGS      = -pipe -stdlib=libc++ -std=c++11 -O2 -Wall -Wextra -O2 -std=gnu++11 $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk -mmacosx-version-min=10.10 -Wall -W -fPIC $(DEFINES)
INCPATH       = -I. -I/anaconda3/include/qt -I/anaconda3/include/qt/QtGui -I/anaconda3/include/qt/QtCore -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk/System/Library/Frameworks/AGL.framework/Headers -I/anaconda3/mkspecs/macx-clang
...
DISTDIR = /Users/vkozlov/Desktop/master/.tmp/ASearch1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk -mmacosx-version-min=10.10 -Wl,-rpath,@executable_path/Frameworks -Wl,-rpath,/anaconda3/lib
...
distdir: FORCE
	...
	$(COPY_FILE) --parents tinyxml2.h node.h gl_const.h xmllogger.h isearch.h mission.h map.h ilogger.h dijkstra.h config.h astar.h searchresult.h environmentoptions.h theta.h $(DISTDIR)/
	$(COPY_FILE) --parents tinyxml2.cpp xmllogger.cpp isearch.cpp mission.cpp map.cpp dijkstra.cpp config.cpp astar.cpp main.cpp environmentoptions.cpp theta.cpp $(DISTDIR)/
...
theta.o: theta.cpp theta.h \
		...
		searchresult.h \
		environmentoptions.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o theta.o theta.cpp
